...
const updateDirs = function updateDirs(fileobjlist:fileobj[]):Promise<fileobj[]>{
...
const setDirs = function setDirs(fileobjlist:fileobj[]):Promise<fileobj[]>{

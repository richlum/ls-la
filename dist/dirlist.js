...
let dirlist;
let fullrootpath = path.resolve(rootdir);
let filelist;
console.log('fullrootpath', fullrootpath);
const updateDirs = function updateDirs(fileobj) {
    console.log(19, 'updateDirs enter', path.relative(fullrootpath, fileobj.fullpath), fileobj.fullpath, fileobj);
...
const getDirList = function getDirList(rootdir) {
    ...
    return new Promise(function (resolve, reject) {
        let fileobj = { fullpath: rootdir, isdir: true };
        let fullpathfiles;
...
const setDirs = function setDirs(fileobj) {
